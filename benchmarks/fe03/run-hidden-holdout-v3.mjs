...
if(!bundlePath||!expectedSha){
  console.error("USAGE|node benchmarks/fe03/run-hidden-holdout-v3.mjs --bundle=<holdout.json> --sha256=<sealed-sha256>");
  process.exit(2);
}
...
const holdoutThresholds=JSON.parse(await readFile("benchmarks/fe03/thresholds.holdout.v3.json","utf8"));
...
const checks={
  seal_matches:true,
  candidate_frozen:h.candidate_sha==="28451d3207a630ac53fed377c5a4a1e126ced87a",
