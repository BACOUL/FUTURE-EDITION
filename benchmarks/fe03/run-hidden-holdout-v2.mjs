...
const holdoutThresholds=JSON.parse(await readFile("benchmarks/fe03/thresholds.holdout.v2.json","utf8"));
...
const checks={
  seal_matches:true,
  candidate_frozen:h.candidate_sha==="61d247da71a03e80a7275ba0c792a079f7221701",
